...
class Ps_ImageSlider extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->templateFileMobile = 'module:ps_imageslider/views/templates/hook/slider_mobile.tpl';
    }
            ...
            foreach ($languages as $language) {
                ...
                if (isset($_FILES['image_mobile_'.$language['id_lang']]) &&
                    ...
                    if ($error = ImageManager::validateUpload($_FILES['image_mobile_'.$language['id_lang']])) {
                        ...
                        return false;
                    } elseif (!ImageManager::resize($temp_name, __DIR__.'/images_mobile/'.$salt.'_'.$_FILES['image_mobile_'.$language['id_lang']]['name'], null, null, $type)) {
                        $errors[] = $this->displayError($this->getTranslator()->trans('An error occurred during the image upload process.', array(), 'Admin.Notifications.Error'));
                    }
                    if (isset($temp_name)) {
                        @unlink($temp_name);
    ...
    public function renderWidget($hookName = null, array $configuration = [])
    {
        /*if($this->context->isMobile()) {
            if (!$this->isCached($this->templateFile, $this->getCacheId('slider_mobile'))) {
                $this->smarty->assign($this->getWidgetVariables($hookName, $configuration));
            }

            return $this->fetch($this->templateFileMobile, $this->getCacheId('slider_mobile'));
        }*/
    ...
    public function clearCache()
    {
        ...
        //$this->_clearCache($this->templateFileMobile);
    }
    ...
    public function getSlides($active = null)
    {
        ...
        foreach ($slides as &$slide) {
            if($this->context->isMobile()) {
                $slide['image_url'] = $this->context->link->getMediaLink(_MODULE_DIR_.'ps_imageslider/images_mobile/'.$slide['image_mobile']);
            } else {
    ...
    public function renderList()
    {
        ...
        $this->context->smarty->assign(
            array(
                ...
                'image_mobile_baseurl' => $this->_path.'images_mobile/'
            )
        );
    ...
    public function renderAddForm()
    {
        ...
        if (Tools::isSubmit('id_slide') && $this->slideExists((int)Tools::getValue('id_slide'))) {
            ...
            $fields_form['form']['images']['image'] = $slide->image;
            $fields_form['form']['images']['image_mobile'] = $slide->image_mobile;
