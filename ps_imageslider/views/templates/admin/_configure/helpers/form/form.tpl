	...
	{if $input.type == 'file_lang'}
		<div class="row">
			{foreach from=$languages item=language}
				...
				{/if}
					<div class="col-lg-6">
						{if isset($fields[0]['form']['images'][$input.name])}
						<img src="{if $input.name == 'image_mobile'}{$image_mobile_baseurl}{else}{$image_baseurl}{/if}{$fields[0]['form']['images'][$input.name][$language.id_lang]}" class="img-thumbnail" />
						{/if}
